...
%
\begin{align*}
	\varphi, \psi ::= \true \sep \false \sep p \sep \neg \varphi \sep \varphi \wedge \psi \sep \X \varphi \sep \varphi \U \psi,
\end{align*}
%
where $p \in P$.
%
...
%
\begin{align}
	\label{eq:fixpoint expansions U}
	\varphi \U \psi
		&= \psi \vee (\varphi \wedge \X (\varphi \U \psi)), \\
	\label{eq:fixpoint expansions R}
	\varphi \Release \psi
		&= \psi \wedge (\varphi \vee \X (\varphi \Release \psi)).
\end{align}
...
to the fixpoint expansions given above~\cref{eq:fixpoint expansions U,eq:fixpoint expansions R}.
